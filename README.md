...
<table align="center" width="100%" style="border-collapse: collapse; border: none;">
  ...
  <tr>
    ...
    <td width="50%" valign="top" align="left" style="padding: 15px;">
      ...
      <p>
        <code>Java & C++ Tournament - <bold>1st place</bold></code>
      </p>
    </td>
  </tr>
  ...
  <tr>
    <!-- 3rd -->
    <td width="50%" valign="top" align="left" style="padding: 15px;">
      <h3><a href="https://www.nadcup.ir/" target="_blank">NadCup - by Sharif University</a></h3>
      <p style="font-size: 14px; color: #b3b3b3;">
        The 30th Innovation and Initiative Competition (Nadcup Sharif 30) held at the Sharif university on April 30 and May 1, 2026.
      </p>
      <p>
        <code>Java & C++ Tournament - <bold>1st place</bold></code>
      </p>
